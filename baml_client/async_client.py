...
class BamlAsyncClient:
    ...
    async def SummarizeCluster(self, stories: typing.List[str],location_name: str,zoom_level: int,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SummarizeCluster", args={
...
class BamlStreamClient:
    ...
    def SummarizeCluster(self, stories: typing.List[str],location_name: str,zoom_level: int,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ClusterSummary, types.ClusterSummary]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SummarizeCluster", args={
            "stories": stories,"location_name": location_name,"zoom_level": zoom_level,
        })
        return baml_py.BamlStream[stream_types.ClusterSummary, types.ClusterSummary](
          result,
...
class BamlHttpRequestClient:
    ...
    async def SummarizeCluster(self, stories: typing.List[str],location_name: str,zoom_level: int,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SummarizeCluster", args={
            "stories": stories,"location_name": location_name,"zoom_level": zoom_level,
        }, mode="request")
        return result
